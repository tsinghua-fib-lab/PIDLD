...
def namespace2dict(ns: argparse.Namespace) -> dict:
...
def get_namespace_value(namespace: argparse.Namespace, keys: List[str]):
...
def set_namespace_value(namespace: argparse.Namespace, key:str, value: object):
...
def get_leaf_nodes(d:dict, parent_key: str=''):
