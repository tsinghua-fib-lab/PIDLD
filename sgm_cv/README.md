# PID-Controlled Anneal Langevin Dynamics Sampling Based on NCSNv2 -- Computer Vision Task
...
| `-P`/`--k_p`          | float \| None | 1.0                 | Coefficient for Proportional Gain. Example: `--k_p 0.1`                                                       |
| `-I`/`--k_i`          | float \| None | 0.0                 | Coefficient for Integral Gain. Example: `--k_i 0.01`                                                          |
| `-D`/`--k_d`          | float \| None | 0.0                 | Coefficient for Differential Gain. Example: `--k_d 0.001`                                                     |
...
| `-T`/`--n_steps_each` |   int \| None | `None`              | Number of sampling steps per noise level. Example: `--n_steps_each 100`                                       |
| `-L`/`--num_classes`  |   int \| None | `None`              | Number of noise levels (classes). Example: `--num_classes 10`                                                 |
